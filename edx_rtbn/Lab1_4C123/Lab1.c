...
/* This example accompanies the books
 ...
 sund : 17-02-2018 Implement Lab1 from Realtime Bluetooth Networks
 */
...
int main(void){
  ...
  TExaS_Init(GRADER, 5618);         // initialize the Lab 1 grader
//  TExaS_Init(LOGICANALYZER, 1000);  // initialize the Lab 1 logic analyzer
  ...
  while(1){
		...
		{
			Task0(); // sample microphone at 1 kHz			
			if(i%100 == 0) // Sample these at 10 Hz
			{
